...
class GarfieldDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  public:
    ...
    const G4VPhysicalVolume* GetDriftTubePVO() const;
...
inline const G4VPhysicalVolume* GarfieldDetectorConstruction::GetDriftTubePVO() const  {
  return fTubePVO;
}
